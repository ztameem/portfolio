...
these are the words of our national anthem!`,
    originalExcerpt:
      "ولوصف زهر اللوز، لا موسوعةُ الأزهار تسعفني، ولا القاموسُ يسعفني… سيخطفني الكلام إلى أَحابيل البلاغةِ / والبلاغَةُ تجرح المعنى وتمدح جُرْحَهُ، كمذكَّرٍ يُمْلي على الأُنثى مشاعرها / فكيف يشعُّ زهر اللوز في لغتي أَنا وأنا الصدى؟",
